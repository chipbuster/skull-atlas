webmol.model.Atom = Backbone.Model.extend({

    init: function (options) {

        this.seqid = options.seqid;
        this.label = options.label;
        this.amino_label = options.amino_label;
        this.amino_seq = options.amino_seq;
        this.position = options.position;
        this.radius = webmol.model.Atom.getRadiusVdw(options.label);
    ...
    getRadiusVdw: function (label) {

        var info = webmol.model.Atom.info,
            label = (label in info) ? label : label[0];
